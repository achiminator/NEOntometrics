...
public class CountSymmetricObjectPropertyAxiomsMetric extends ObjectPropertyAxiomsMetric {
	...
	public Integer getValue() {
		...
		// return ontology.getAxiomCount(AxiomType.SYMMETRIC_OBJECT_PROPERTY, true);
