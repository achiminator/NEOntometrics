...
class Metrics(models.Model):
    ...
    Absolutedepth = models.PositiveIntegerField(default=0)
    Averagedepth = models.FloatField(default=0)
    Maximaldepth = models.PositiveIntegerField(default=0)
    Absolutebreadth = models.PositiveIntegerField(default=0)
    Averagebreadth = models.FloatField(default=0)
    Maximalbreadth = models.PositiveIntegerField(default=0)
    ...
    Totalnumberofpaths = models.PositiveIntegerField(default=0)
