...
class Commit(models.Model):
    ...
    individualAnnotations  = models.PositiveBigIntegerField(default = None, null=True)
    ...
    deprecatedDataTypes = models.PositiveIntegerField(default=None, null=True)
    deprecatedObjectProperties = models.PositiveIntegerField(default=None, null=True)
    deprecatedClasses = models.PositiveIntegerField(default=None, null=True)
    deprecatedDataProperties = models.PositiveIntegerField(default=None, null=True)
    deprecatedIndividuals = models.PositiveIntegerField(default=None, null=True)
